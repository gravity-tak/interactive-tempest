...
def c_env(ctype=0):
    ...
    if ctype >= 3:
        ...
        jfile1 = 'itempest/data/topo-cirros-01.json'
        jfile2 = 'itempest/data/topo-cirros-02.json'
    earth_mgr = osn.icreds.get_client_manager(osn.auth_url,
                                              'Earth', 'itempest')
    earth1 = stn.SimpleTenantNetworks(earth_mgr, jfile1,
                                      prefix_name='earth1')
    earth2 = stn.SimpleTenantNetworks(earth_mgr, jfile2,
                                      prefix_name='earth2')
...
# TODO(akang): Is it possible to build static routes
#              between earth1-router and earth2-router
def b_static_routes():
    r1 = earth1.qsvc('router-list', name='earth1-expo-router')[0]
    earth1.qsvc('router-update-extra-routes', r1['id'],
                '10.168.11.3', '10.8.3.1/24')
