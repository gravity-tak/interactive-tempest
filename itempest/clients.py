...
from tempest.lib.services.identity.v3.roles_client import \
...
class Manager(manager.Manager):
    ...
    def __init__(self, credentials, os_auth_url, service=None,
                 verbose=False):
        ...
        # overwrite the default as we don't want to rely on tempest.conf
        CONF.identity.uri = CONF.identity.uri_v3 = os_auth_url
